...
public enum StyleDictionaryEnum {
    ...
    public static let expCompositionButtonPaddingLargeX = 1.5rem
    public static let expCompositionButtonPaddingLargeY = 1rem
    public static let expCompositionButtonPaddingMediumX = 1.25rem
    public static let expCompositionButtonPaddingMediumY = .75rem
    public static let expCompositionButtonPaddingSmallX = 1rem
    public static let expCompositionButtonPaddingSmallY = .5rem
    ...
    public static let expCompositionCardBackgroundColorDefault = hsl(0, 0%, 100%)
    ...
    public static let expCompositionTextinputErrorMessageBorderColor = hsl(0, 95%, 50%)
